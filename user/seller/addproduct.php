    ...
    <section class="content">
     ...
     <div class="box box-warning">
      ...
      <?php
        ...
        if($_GET['flag']==1)
          {
            echo "<center><font style='color:green; text-align:center'>Products Added Successfully</font></center><br/>";
      ...
      ?>  
      <br/>
              <form role="form" method="POST" action="insert_product.php" enctype="multipart/form-data" >
                <!-- text input -->
                <div class="form-group">
                          <label>Product_Name</label>
                          <input type="text" name="Product_Name" class="form-control" placeholder="Enter Product_Name ..." required />
                </div>
                ...
                <div class="form-group">    
                          ...
                          <select name="Pet_Category" class="form-control" required>
                                <option value="0">Pet_Category</option>
