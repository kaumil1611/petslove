...
<?php
  ...
  if(isset($_GET['del']))
  {
    ...
    echo "<script> location.replace('manageordermedicine.php') </script>";
  }
?>
<!DOCTYPE html>
<html>
...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Manage Order for Medicine
        <small>Admin panel</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="dashboard.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Manage Order for Medicine</li>
      </ol>
    </section>
      ...
      <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Manage Order for Medicine</h3>
        ...
        <?php
          ...
          $ord = mysqli_query($con,"SELECT * FROM ORDER_DETAILS WHERE SELLER_ID='$sid' AND MEDICINE_ID!=''");
        ...
        ?>
                <tr>
                  <td><?php echo $seq;?></td>
                  <td><?php 
                    $MID = $value2['MEDICINE_ID'];
                     $mid1 = mysqli_query($con,"SELECT MEDICINE_NAME FROM MEDICINE WHERE MEDICINE_ID='$MID'"); 
                     $mid2 = mysqli_fetch_array($mid1);
                     echo $mid2['MEDICINE_NAME'];?>
                  </td>
                  <td><?php 
          ...
          <td> 
          <a class="btn btn-info btn-xs" href="ordermedicine.php?oid=<?php echo $value2['ORDER_ID'];?> " 
