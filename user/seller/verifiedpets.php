    ...
    <section class="content">
      ...
      <div class="col-xs-12">
        ...
        <?php
          ...
          $query="SELECT * FROM PETS WHERE SELLER_ID='$sid' AND VERIFIED=1";
        ...
        ?>
          ...
          <td> 
          <a class="btn btn-info btn-xs" href="editprofile.php?id=<?php echo $value2['login_id'];?> " 
          onclick="return confirm('sure to edit?');">VIEW</a> &nbsp;&nbsp;
          </td>
        </tr>
