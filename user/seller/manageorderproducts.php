...
<?php
  ...
  if(isset($_GET['del']))
  {
    ...
    $sql1="UPDATE ORDER_DETAILS SET PRODUCT_ID='' WHERE ORDER_ID=".$_GET['del']."";
...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Manage Order for Products
        <small>Admin panel</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="dashboard.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Manage Order for Products</li>
      </ol>
    </section>
      ...
      <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Manage Order for Products</h3>
        ...
        <?php
          ...
          $ord = mysqli_query($con,"SELECT * FROM ORDER_DETAILS WHERE SELLER_ID='$sid' AND PRODUCT_ID!=''");
        ...
        ?>
                <tr>
                  <td><?php echo $seq;?></td>
                  <td><?php 
                    $PID = $value2['PRODUCT_ID'];
                     $mid1 = mysqli_query($con,"SELECT PRODUCT_NAME FROM PRODUCTS WHERE PRODUCT_ID='$PID'"); 
                     $mid2 = mysqli_fetch_array($mid1);
                     echo $mid2['PRODUCT_NAME'];?>
                  </td>
                  <td><?php 
          ...
          <td> 
          <a class="btn btn-info btn-xs" href="orderproduct.php?oid=<?php echo $value2['ORDER_ID'];?> " 
