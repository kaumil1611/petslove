    ...
    <section class="content">
      ...
      <div class="col-xs-12">
        ...
        <?php
          ...
          $query="SELECT * FROM PETS WHERE SELLER_ID='$sid' AND VERIFIED=0" ;
        ...
        ?>
          ...
          <td> 
          <a class="btn btn-info btn-xs" href="viewpet.php?pid=<?php echo $value2['PET_ID'];?> " 
          onclick="return confirm('sure to view detail?');">VIEW</a> &nbsp;&nbsp;
          <a class="btn btn-success btn-xs" href="editpet.php?pid=<?php echo $value2['PET_ID'];?> " 
