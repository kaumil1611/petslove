    ...
    <section class="content">
      ...
      <div class="col-xs-12">
        ...
        <?php
          ...
          $query="SELECT * FROM MEDICINE WHERE SELLER_ID='$sid'" ;
        ...
        ?>
          ...
          <td> 
          <a class="btn btn-info btn-xs" href="viewmedicine.php?pid=<?php echo $value2['MEDICINE_ID'];?> " 
          onclick="return confirm('sure to view detail?');">VIEW</a> &nbsp;&nbsp;
          <a class="btn btn-success btn-xs" href="editmedicine.php?pid=<?php echo $value2['MEDICINE_ID'];?> " 
