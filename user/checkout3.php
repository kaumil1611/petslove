...
<body>
	...
	<?php	
		...
		while ($data=mysqli_fetch_array($ffetch)) {
			...
			$pimage=$get1['IMAGE_1'];
			$pprice=$get1['PRICE'];
			$product_id_fetch=$get1['PRODUCT_ID'];
			echo $product_id_fetch;
	...
	?>
						...
						<tr>
							<td class="invert"><?php echo $i ; ?></td>
								<td class="invert-image">
									<a href="single.php">
										<img src="<?php echo $pimage; ?>" height=160 width=160 class="img-responsive">
									</a> 
								</td>
							...
							<script src="js/bootstrap.js"></script>
								...
								<td id="total" class="total1"><?php echo $pprice; ?></td><!-- sudharvanu 6 -->
								<td class="invert">
									<div class="rem">
										<div class="close1"> 
						...
						<tr>
							<td class="invert"><?php echo $i ; ?></td>
								<td class="invert-image">
									<a href="single.php">
										<img src="<?php echo $pet_image; ?>" height=160 width=160 class="img-responsive">
									</a> 
								</td>
								<td class="invert">
									<div class="quantity">
										<input type="text" name="quantity" value="<?php echo $four ; ?>">
									</div>
								</td>
								<td class="invert"><?php echo $pet_name; ?></td>
								<td class="invert"><?php echo $pet_price; ?></td>
								<td id="total" class="total">0</td><!-- sudharvanu 6 -->
								<td class="invert">
									<div class="rem">
						...
						<tr>
							<td class="invert"><?php echo $i ; ?></td>
								<td class="invert-image">
									<a href="single.php">
										<img src="<?php echo $medicine_image; ?>" height=160 width=160 class="img-responsive">
									</a> 
								</td>
								<td class="invert">
									<div class="quantity">
					...
					<form  method="post" class="creditly-card-form agileinfo_form">
						<div class="creditly-wrapper wthree, w3_agileits_wrapper">
							<div class="information-wrapper">
								...
								<input type="submit" name="order" value="order it">
							</div>
						</div>
					</form>
					<?php 
