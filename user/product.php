...
<?php } 
 elseif ($xval=='Grooming products') {
				$p1="SELECT * FROM PRODUCTS where CATEGORY='Gromming Products'";
				$fetchp1= mysqli_query($con,$p1);
						...
						<div class="col-xs-3 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									...
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="single.php?val=<?php echo $row['MEDICINE_ID'] ; ?>"  class="link-product-add-cart">Quick View</a>
										</div>
									</div>
									<span class="product-new-top">New</span>
								</div>
								<div class="item-info-product ">
									<h4>
										<a href="single.php"><?php echo $row['MEDICINE_NAME']; ?></a>
									</h4>
									<div class="info-product-price">
										<span class="item_price"><?php echo $row['PRICE']; ?></span>
										<!--<del><?php// echo $row[//'PRICE']; ?></del>-->
