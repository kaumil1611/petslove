  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Verified Seller</li>
      </ol>
    </section>
      ...
      <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Verified Seller</h3>
        ...
        <?php
          ...
          $query="SELECT LOGIN.EMAIL_ID,LOGIN.LOGIN_ID,LOGIN.PHONE_NO,LOGIN.PROFILE_PIC,SELLER.NAME FROM LOGIN INNER JOIN SELLER ON LOGIN.LOGIN_ID=SELLER.LOGIN_ID WHERE LOGIN.ACTIVE=1 AND LOGIN.ROLE=2";
