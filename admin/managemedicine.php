...
<?php
  ...
  if(isset($_GET['del']))
  {
    ...
    $sql1="DELETE FROM MEDICINE WHERE MEDICINE_ID=".$_GET['del']."";
    $result=mysqli_query($con,$sql1);
    echo "<script> location.replace('managemedicine.php') </script>";
  }
?>
<!DOCTYPE html>
<html>
    ...
    <section class="content">
      ...
      <div class="col-xs-12">
        ...
        $sqry = mysqli_fetch_array($sqry);*/
          ...
          $query="SELECT MEDICINE.MEDICINE_ID,MEDICINE.MEDICINE_NAME,MEDICINE.COMPANY,MEDICINE.PET_CATEGORY,SELLER.NAME FROM MEDICINE INNER JOIN SELLER ON MEDICINE.SELLER_ID=SELLER.SELLER_ID" ;
        ...
        ?>
                <tr>
                  <td><?php echo $seq;?></td>
                  <td><?php echo $value2['MEDICINE_NAME'];?></td>
          ...
          <td> 
          <a class="btn btn-info btn-xs" href="viewmedicine.php?mid=<?php echo $value2['MEDICINE_ID'];?> " 
          onclick="return confirm('sure to view detail?');">VIEW</a> &nbsp;&nbsp;
          <a class="btn btn-danger btn-xs" href="?del=<?php echo $value2['MEDICINE_ID'];?>" 
