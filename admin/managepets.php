...
<?php
  ...
  if(isset($_GET['verify']))
  {
    ...
    $sql1="UPDATE PETS SET VERIFIED=1 WHERE PET_ID=".$_GET['verify']."";
    $result=mysqli_query($con,$sql1);
    echo "<script> location.replace('verifiedpets.php') </script>";
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Manage Pets</li>
      </ol>
    </section>
      ...
      <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Manage Pets</h3>
        ...
        <?php
          ...
          $query="SELECT PETS.PET_ID,PETS.BREED,PETS.REGISTRATION_ID,PETS.PET_CATEGORY,SELLER.NAME FROM PETS INNER JOIN SELLER ON PETS.SELLER_ID=SELLER.SELLER_ID WHERE PETS.VERIFIED=0";
        ...
        ?>
          ...
          <a class="btn btn-warning btn-xs" href="?verify=<?php echo $value2['PET_ID'];?>" 
          onclick="return confirm('sure to verify pet?');">VERIFY</a> &nbsp;&nbsp;
