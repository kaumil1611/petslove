...
<html>
<head>
  <title>Admin| Admin Another Admin</title>
</head>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Add Another Admin</li>
      </ol>
    </section>
    ...
    <section class="content">
      <!-- Small boxes (Stat box) -->
	   ...
	   <div class="box box-warning">
          ...
          if($_GET['flag']==2)
          {
            echo "<center><font style='color:green; text-align:center'>Admin Already exist </font></center><br/>";
          }
				}
...
number starting with 7 or 8 or 9' required />
                ...
                <label>Birth Date:</label>
					...
					<input type="text" name="dob" class="form-control pull-right" id="datepicker" autocomplete="off" required />
					</div-->
					<!-- /.input group -->
				<!--/div-->
