...
<?php
  ...
  else
  {
    ...
    $v1 = mysqli_query($con,"SELECT * FROM MEDICINE WHERE MEDICINE_ID='$mid'");
    $get_data1 = mysqli_fetch_array($v1);
    $mid = $get_data1['MEDICINE_ID'];
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Medicine Detail</li>
      </ol>
    </section>
      ...
      <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Medicine Detail</h3>
