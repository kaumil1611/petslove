...
<?php
	...
	else
	{
		...
		$q1="SELECT * FROM ADMIN WHERE LOGIN_ID='$idx'";
...
<?php
	...
	if(isset($_POST['submit']))
	{
		...
		if($_FILES["image"]["name"] != " ")
		{
			...
			$updated = mysqli_query($con,"UPDATE LOGIN SET EMAIL_ID='$email',PROFILE_PIC='$location' WHERE LOGIN_ID='$idx'");
			$updated2 = mysqli_query($con,"UPDATE ADMIN SET NAME='$user' WHERE LOGIN_ID='$idx'");
			$updated3 = mysqli_query($con,"UPDATE LOGIN SET PHONE_NO='$newphone' WHERE LOGIN_ID='$idx'");
		...
		else
		{
			...
			$newphone = $_POST['phn'];
			$email = $_POST['email'];
			$updated = mysqli_query($con,"UPDATE LOGIN SET EMAIL_ID='$email',PHONE_NO='$newphone' WHERE LOGIN_ID='$idx'");
			$updated2 = mysqli_query($con,"UPDATE ADMIN SET NAME='$name' WHERE LOGIN_ID='$idx'");
