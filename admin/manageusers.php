    ...
    <section class="content">
      ...
      <div class="col-xs-12">
        ...
        <?php
          ...
          $query="SELECT LOGIN.EMAIL_ID,LOGIN.LOGIN_ID,LOGIN.PHONE_NO,LOGIN.PROFILE_PIC,BUYER.NAME FROM LOGIN INNER JOIN BUYER ON LOGIN.LOGIN_ID=BUYER.LOGIN_ID WHERE  LOGIN.ACTIVE=1 AND LOGIN.ROLE=3";
        ...
        ?>
          ...
          <td> 
          <a class="btn btn-info btn-xs" href="viewuser.php?vid=<?php echo $value2['LOGIN_ID'];?> " 
